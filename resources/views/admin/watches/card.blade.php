                    ...
                    <div class="grid grid-cols-1 md:grid-cols-12 items-center p-6 gap-4">
                        ...
                        <div class="col-span-2 flex items-center space-x-4">
                            <div class="w-12 h-12 bg-stone-950 flex items-center justify-center border border-white/10 p-1">
                                <img src="" alt="" class="max-w-full max-h-full object-contain grayscale group-hover:grayscale-0 transition-all duration-700">
                            </div>
                            <div>
                                <h4 class="text-white text-sm font-medium uppercase tracking-tight"></h4>
                                <p class="text-[8px] text-stone-500 uppercase tracking-widest leading-none">Ref.</p>
                            </div>
                        </div>

                        <div class="col-span-2">
                            <span class="text-[10px] text-stone-400 uppercase tracking-wider"></span>
                        </div>
                        ...
                        <div class="col-span-2">
                            <span class="text-amber-500 font-serif text-md">$</span>
                        </div>

                        <div class="col-span-2">
                            
                                <span class="px-3 py-1 bg-emerald-500/5 border border-emerald-500/20 text-[8px] text-emerald-500 uppercase tracking-widest">
                                    Available
                                </span>
                           
                                <span class="px-3 py-1 bg-red-500/5 border border-red-500/20 text-[8px] text-red-500 uppercase tracking-widest">
                                    Sold Out
                                </span>

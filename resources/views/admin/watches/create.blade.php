            ...
            <form id="watch-form" action="#" method="POST" class="grid grid-cols-1 lg:grid-cols-3 gap-10 pb-20">
                ...
                <div class="lg:col-span-2 space-y-10">
                    ...
                    <div class="bg-zinc-900 p-8 rounded-none border border-white/5 relative shadow-2xl">
                        <div class="absolute top-0 left-0 w-full h-[2px] bg-yellow-400"></div>
                        <h2 class="text-lg font-black text-white mb-8 uppercase tracking-widest flex items-center gap-3">
                            <span class="text-yellow-400 text-2xl">02</span> Pricing & Stock
                        </h2>
                ...
                <div class="space-y-10">
                            ...
                            <div>
                                ...
                                <div class="grid grid-cols-2 gap-px bg-zinc-800 border border-zinc-800">
                                    <label class="flex items-center justify-center p-3 bg-black cursor-pointer hover:bg-zinc-900 has-[:checked]:bg-yellow-400 has-[:checked]:text-black text-white transition-all group">
                                        <input type="radio" name="status" checked class="hidden">
                    ...
                    <div class="bg-yellow-400 p-8 rounded-none text-black shadow-[0_20px_40px_rgba(250,204,21,0.15)]">
                        <h4 class="font-black text-xl uppercase tracking-tighter mb-2 italic">Luxury Standards</h4>
                        <p class="text-black/70 text-xs font-bold leading-tight mb-6 uppercase tracking-tight">Ensure macro photography is used for movement highlights.</p>
                        <div class="h-1 w-12 bg-black mb-4"></div>
                        <a href="#" class="text-[10px] font-black underline underline-offset-4 uppercase tracking-[0.2em]">View Specs Guide</a>
                    </div>
                </div>
